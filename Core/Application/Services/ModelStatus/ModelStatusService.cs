...
{
    public class ModelStatusService : BaseService, IModelStatusService
    {
        #region Fields
        private readonly IModelStatusRepository _repository;
        #endregion

        #region Constructor
        public ModelStatusService(IModelStatusRepository repository, IMapper mapper, IUserInfoService userInfoService) : base(mapper, userInfoService)
        {
        ...
        public async Task<ModelStatusInfoDto> GetInfoByIdAsync(int id, EnumLanguage lang)
        {
        ...
        {
            var filter = new ModelStatusFilter
            {
                
            };
            return await GetAllAsLookupAsync(filter);
        }
        public async Task<List<LookupDto>> GetAllAsLookupAsync(ModelStatusFilter filter)
        {
            var list = await GetAllAsync(filter);
            return list.Select(e => new LookupDto(e.ModelStatusId,e.Name)).ToList();
        }
        #endregion
    }
}
