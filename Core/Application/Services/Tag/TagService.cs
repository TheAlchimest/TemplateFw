...
namespace TemplateFw.Application.Services
{
    public class TagService : BaseService, ITagService
    {
        ...
        #region Constructor
        public TagService(ITagRepository repository, IMapper mapper, IUserInfoService userInfoService) : base(mapper, userInfoService)
        {
        ...
        public async Task<TagInfoDto> GetInfoByIdAsync(int id, EnumLanguage lang)
        {
        ...
        public async Task<List<LookupDto>> GetAllAsLookupAsync(TagFilter filter)
        {
            var list = await GetAllAsync(filter);
            return list.Select(e => new LookupDto(e.TagId,e.Title)).ToList();
        }
        #endregion
    }
}
