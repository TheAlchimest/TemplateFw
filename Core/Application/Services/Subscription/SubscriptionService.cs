...
namespace TemplateFw.Application.Services
{
    public class SubscriptionService : BaseService, ISubscriptionService
    {
        ...
        #region Constructor
        public SubscriptionService(ISubscriptionRepository repository, IMapper mapper, IUserInfoService userInfoService) : base(mapper, userInfoService)
        {
        ...
        public async Task<SubscriptionInfoDto> GetInfoByIdAsync(int id, EnumLanguage lang)
        {
        ...
        public async Task<List<LookupDto>> GetLookupAsync(int? userId = null, int? subscriptionPlanId = null, int? subscriptionStatusId = null)
        {
        ...
        public async Task<List<LookupDto>> GetAllAsLookupAsync(SubscriptionFilter filter)
        {
            var list = await GetAllAsync(filter);
            return list.Select(e => new LookupDto(e.SubscriptionId,e.FirstName)).ToList();
        }
        #endregion
    }
}
