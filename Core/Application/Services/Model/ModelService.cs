...
namespace TemplateFw.Application.Services
{
    public class ModelService : BaseService, IModelService
    {
        ...
        #region Constructor
        public ModelService(IModelRepository repository, IMapper mapper, IUserInfoService userInfoService) : base(mapper, userInfoService)
        {
        ...
        public async Task<ModelInfoDto> GetInfoByIdAsync(int id, EnumLanguage lang)
        {
        ...
        public async Task<List<LookupDto>> GetLookupAsync(int? countryId = null, int? categoryId = null, int? portalId = null, int? serviceId = null, int? modelStatusId = null)
        {
        ...
        public async Task<List<LookupDto>> GetAllAsLookupAsync(ModelFilter filter)
        {
            var list = await GetAllAsync(filter);
            return list.Select(e => new LookupDto(e.ModelId,e.Title)).ToList();
        }
        #endregion
    }
}
