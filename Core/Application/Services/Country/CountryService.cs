...
namespace TemplateFw.Application.Services
{
    public class CountryService : BaseService, ICountryService
    {
        ...
        #region Constructor
        public CountryService(ICountryRepository repository, IMapper mapper, IUserInfoService userInfoService) : base(mapper, userInfoService)
        {
        ...
        public async Task<CountryInfoDto> GetInfoByIdAsync(int id, EnumLanguage lang)
        {
        ...
        public async Task<List<LookupDto>> GetAllAsLookupAsync(CountryFilter filter)
        {
            var list = await GetAllAsync(filter);
            return list.Select(e => new LookupDto(e.CountryId,e.Name)).ToList();
        }
        #endregion
    }
}
