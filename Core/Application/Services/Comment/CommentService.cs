...
namespace TemplateFw.Application.Services
{
    public class CommentService : BaseService, ICommentService
    {
        ...
        #region Constructor
        public CommentService(ICommentRepository repository, IMapper mapper, IUserInfoService userInfoService) : base(mapper, userInfoService)
        {
        ...
        public async Task<CommentInfoDto> GetInfoByIdAsync(int id, EnumLanguage lang)
        {
        ...
        public async Task<List<LookupDto>> GetLookupAsync(int? articleId = null, int? userId = null)
        {
        ...
        public async Task<List<LookupDto>> GetAllAsLookupAsync(CommentFilter filter)
        {
            var list = await GetAllAsync(filter);
            return list.Select(e => new LookupDto(e.CommentId,e.Content)).ToList();
        }
        #endregion
    }
}
